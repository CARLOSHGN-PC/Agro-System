...
export const filtroRelatorioEstimativaSchema = z.object({
  ...
  dataEstimativaInicio: z.string().date().optional(), // Expected YYYY-MM-DD
  dataEstimativaFim: z.string().date().optional(),
  dataReestimativaInicio: z.string().date().optional(),
  dataReestimativaFim: z.string().date().optional(),
